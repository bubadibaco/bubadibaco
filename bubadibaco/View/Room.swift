...
struct Room: View {
    ...
    let frameSizes: [String: CGSize] = [
        ...
        "Brush": CGSize(width: 100, height: 100),
        "Duck": CGSize(width: 200, height: 200),
    ...
    @State private var itemOffsets: [String: CGPoint] = [
        ...
        "Toothpaste": CGPoint(x: -2100, y: -100),
        "Toothbrush": CGPoint(x: -650, y: 0),
        "Candle": CGPoint(x: 500, y: 400),
        "Shampoo": CGPoint(x: -750, y: 0),
        "LiquidSoap": CGPoint(x: -800, y: 0),
        "Brush": CGPoint(x: -800, y: 400),
        "Duck": CGPoint(x: -700, y: 400),
        "Razor": CGPoint(x: -700, y: -100),
        "Clock": CGPoint(x: 300, y: 0),
        "Cat": CGPoint(x: 600, y: 300),
        "Plant": CGPoint(x: 500, y: 100),
        "Jar": CGPoint(x: 500, y: 200),
        "Jug": CGPoint(x: -700, y: -100),
        "Bag": CGPoint(x: 700, y: 0),
        "Eggs": CGPoint(x: -600, y: 0),
        "Radio": CGPoint(x: 700, y: -100),
        "Ramen": CGPoint(x: -500, y: -150),
        "Novel": CGPoint(x: 700, y: -200),
        "Cup": CGPoint(x: -300, y: 0),
    ]
